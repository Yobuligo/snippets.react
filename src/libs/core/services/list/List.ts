...
export class List {
  ...
  static first<T>(list: T[]): T {
    return (
      this.firstOrNull(list) ?? throwError(new NoSuchElementError("List is empty"))
    );
  }
  ...
  static last<T>(list: T[]): T {
    return (
      this.lastOrNull(list) ?? throwError(new NoSuchElementError("List is empty"))
    );
  }
  ...
  static random<T>(list: T[]): T {
    return (
      this.randomOrNull(list) ?? throwError(new NoSuchElementError("List is empty"))
    );
  }
